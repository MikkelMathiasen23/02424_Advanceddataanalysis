...
This model does however not fit very well (HVOR KAN VI SE DET). A quick investigation of the residuals would suggest a log-transformation of the response variable. We could also try a Box Cox transformation to see if another transformation might be more useful:
