...
$$ clo_i = \beta_0  + \beta_1sex_i +  \beta_2tOut_i +  \beta_3 tInOp_i+ \mathbf{\beta_{4}time_{i}} + \beta_5sex_i(tInOp_i) + SubjId_i +\mathbf{day_{i}} +  \epsilon_{ij}$$
...
```{r resid_2,fig.cap="This graph displays the residuals splitted into gender presented in a QQ-plot."}
...
```{r variogram, fig.cap="Variograms for Gaussian and Exponential correlation structure.",fig.height=4}
par(mfrow = c(1, 2))
