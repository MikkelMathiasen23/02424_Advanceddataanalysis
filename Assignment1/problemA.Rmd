...
From figure \ref{fig:pred_2} it can be seen that the prediction interval for the females are more wide compared to the unweighted model resulting in more points are within the prediction interval. Clearly, it can be seen that the prediction interval for females are more wide compared to males, which might be due to the weighting of the residuals. As in figure \ref{fig:pred_1} it can be seen that the prediction and prediction interval are shifted down when the indoor operating temperature are elevated, whereas it appears to be rather constant for males.  
